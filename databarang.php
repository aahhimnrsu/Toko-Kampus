    ...
    <div class="container mt-5 p-5">
        <div class="row row-cols-1 row-cols-md-3">
            ...
            ?>
                <div class="col mb-4">
                    <div class="card">
                        <img src="<?= "backend/".$d['foto']; ?>" class="card-img-top" alt="<?= $d['barang']; ?>" width="100px">
                        <div class="card-body">
                            ...
                            <div class="position-relative d-flex justify-content-around">
                                <a href="backend/edit.php?kode=<?php echo $d['kode']; ?>" class="btn btn-outline-success">Edit</a>
                                <a href="backend/hapusbarang.php?kode=<?php echo $d['kode']; ?>" class="btn btn-outline-danger">Hapus</a>
                            </div>
                        </div>
                    </div>
                </div>
